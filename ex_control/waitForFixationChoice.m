function choice = waitForFixationChoice(waitTime,fixX,fixY,r,varargin)
...
% Created 24Feb2012 by Adam Snyder (adam@adamcsnyder.com)
...
while 1
    ...
    for i = 1:numWindows
        ...
        if relEyePos(1) > -r(i) && relEyePos(1) < r(i) && relEyePos(2) > -r(i) && relEyePos(2) < r(i)
            choice = i;
            break;
        end
