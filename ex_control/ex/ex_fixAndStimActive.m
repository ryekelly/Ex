function result = ex_fixAndStimActive(e)
% ex file: ex_fixAndStimActive
%
...
% 2012/11/15 by Matt Smith - renamed old fixAndStim to fixAndStimActive
% because it has a saccade at the end
